...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-[#f6f8fa] shadow-sm text-black bg-white dark:bg-gray-900 text-black dark:text-white">
            ...
            <div className="bg-white dark:bg-gray-900 text-black dark:text-white p-5">
  Dark Mode Test Box
</div>
        </div>
    );

    ...
    return (
        <div className="navbar bg-[#f6f8fa] shadow-sm text-black">
            <div className="navbar-start ">
                ...
                <NavLink to='/'>
                    <button className="btn flex items-center text-xl text-black bg-transparent shadow-none hover:bg-transparent hover:shadow-none focus:shadow-none active:shadow-none border-none "><img src={log} alt="Logo" className="w-6" />
                        JobsZone</button>
                </NavLink>
            </div>

...
import logo from '../../assets/logo.png'; // লোগো ফাইল পাথ ঠিক করুন

const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-primary text-white p-10 rounded-t-2xl shadow-inner">
            <div className="mb-4">
            ...
            <nav className="mt-6 flex justify-center space-x-6 text-lg font-medium">

    ...
    return (
        <div className="max-w-xl mx-auto p-6 bg-white rounded shadow my-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input name="displayN" type="text" value={user?.displayName || "No Name"} readOnly className="input input-bordered w-full bg-gray-100" />
                <input name="" type="email" value={user?.email || "No email"} readOnly className="input input-bordered w-full bg-gray-100" />

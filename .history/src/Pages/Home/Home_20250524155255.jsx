                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {
                            allGroups.map(singleGroup => {
                                <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-xl shadow hover:shadow-lg transition">
                                    ...
                                    />
                                    <h3 className="text-lg font-semibold">{singleGroup.}</h3>
                                    <p className="text-gray-500">{singleGroup.}</p>
                                </div>
                            })
                        }
                    </div>
                    <button type="button" className="mx-auto flex mt-8 px-8 py-3 font-semibold rounded-full dark:bg-gray-800 dark:text-gray-100"><span className=''>See More</span><span className=' pt-1 ml-2'><FaArrowRight /></span></button>
                </div>

        ...
        <div className="text-gray-800 dark:text-gray-100">
            ...
            <section className="py-16 bg-white dark:bg-gray-900">
                <div className="max-w-6xl mx-auto px-4 text-center">
                    ...
                    <button type="button" className="flex mt-8 px-8 py-3 font-semibold rounded-full dark:bg-gray-800 dark:text-gray-100"><span className='border-1'>See More</span><span className='border-1 pt-1 ml-2'><FaArrowRight /></span></button>
                </div>

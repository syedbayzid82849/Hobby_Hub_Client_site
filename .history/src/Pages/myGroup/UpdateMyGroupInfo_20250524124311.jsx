        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg w-[90%] max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="grid gap-3">
                    ...
                    <input name="displayName" type="text" value={g.displayName || "No Name"} readOnly className="input input-bordered w-full bg-gray-100" />
                    <input name="email" type="email" value={g.email || "No email"} readOnly className="input input-bordered w-full bg-gray-100" />

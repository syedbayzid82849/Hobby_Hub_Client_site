        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="grid gap-3">
                    ...
                    <input type="submit" className="px-3 py-1 bg-blue-600 text-white rounded">Save</input>
                    <Link to={'/my-groups'}><                        <input type="submit" className="px-3 py-1 bg-blue-600 text-white rounded">Save</input>
 type="button" className="px-3 py-1 bg-gray-400 text-white rounded">Cancel</button></Link>
                </form>
            </div>
        </div>
    );

        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg w-[90%] max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="grid gap-3">
                    ...
                    <input type="date" name="startDate" defaultValue={startDate} className="input input-bordered w-full" required />

                    <input type="url" name="imageUrl" defaultValue={imageUrl} placeholder="Image URL" className="input input-bordered w-full" />

                    <input name="displayName" type="text" value={displayName || "No Name"}  className="input input-bordered w-full bg-gray-100" />
                    <input name="email" type="email" value={email || "No email"}  className="input input-bordered w-full bg-gray-100" />
